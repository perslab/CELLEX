...
def human_symbol_to_human_ens(df_unmapped: pd.DataFrame, drop_unmapped: bool=False, verbose: bool=False) -> None:
    """Map dataframe index human gene symbol to human ensemble id inplace
    ...
    if verbose:
        print("Mapping: human gene symbols --> human ensembl gene id's ...")
    
    resource_package = __name__
    resource_path = 'maps/Homo_sapiens.GRCh38.ens_v90.gene_name_version2ensembl.txt.gz'  # Do not use os.path.join()
